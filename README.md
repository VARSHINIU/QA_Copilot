...
├── screenshots/
│   ├── DOWNLOADABLE_TICKET_OUTPUT.png       # Downloadable ticket generated by QA Copilot
...
│   ├── TEST_GENERATOR_OUTPUT.png            # Test Generator Agent — generated Playwright POM code
│   ├── QA_Copilot_workflow.png              # Shows how the entire QA Copilot works
│   ├── Orchestrator_Workflow.png            # Shows how the Orchestrator (multi-agent) works
│   └── Agents_Workflow.png                  # Shows how each individual agent works
